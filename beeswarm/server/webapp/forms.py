...
class NewClientConfigForm(Form):
    ...
    http_server = StringField(default='127.0.0.1', label='Server IP')
    http_port = IntegerField(default=80, label='Port')
    http_active_range = StringField(validators=[validate_time_range], default='00:00 - 23:59',
                                    description='<small><em>hh:mm - hh:mm</em></small>', label='Activity Time')
    http_sleep_interval = StringField(default=720, label='Sleep Interval')
    http_activation_probability = StringField(default=0.4, label='Activation Probability')
    http_login = StringField(default='test', label='Login')
    http_password = StringField(default='password', label='Password')

    https_enabled = BooleanField(default=False, label='Enabled')
    https_server = StringField(default='127.0.0.1', label='Server IP')
    https_port = IntegerField(default=443, label='Port')
    https_active_range = StringField(validators=[validate_time_range], default='00:00 - 23:59',
                                     description='<small><em>hh:mm - hh:mm</em></small>', label='Activity Time')
    https_sleep_interval = StringField(default=720, label='Sleep Interval')
    https_activation_probability = StringField(default=0.4, label='Activation Probability')
    https_login = StringField(default='test', label='Login')
    https_password = StringField(default='password', label='Password')

    pop3_enabled = BooleanField(default=False, label='Enabled')
    pop3_server = StringField(default='127.0.0.1', label='Server IP')
    pop3_port = IntegerField(default=110, label='Port')
    pop3_active_range = StringField(validators=[validate_time_range], default='00:00 - 23:59',
                                    description='<small><em>hh:mm - hh:mm</em></small>', label='Activity Time')
    pop3_sleep_interval = StringField(default=720, label='Sleep Interval')
    pop3_activation_probability = StringField(default=0.4, label='Activation Probability')
    pop3_login = StringField(default='test', label='Login')
    pop3_password = StringField(default='password', label='Password')

    pop3s_enabled = BooleanField(default=False, label='Enabled')
    pop3s_server = StringField(default='127.0.0.1', label='Server IP')
    pop3s_port = IntegerField(default=995, label='Port')
    pop3s_active_range = StringField(validators=[validate_time_range], default='00:00 - 23:59',
                                     description='<small><em>hh:mm - hh:mm</em></small>', label='Activity Time')
    pop3s_sleep_interval = StringField(default=720, label='Sleep Interval')
    pop3s_activation_probability = StringField(default=0.4, label='Activation Probability')
    pop3s_login = StringField(default='test', label='Login')
    pop3s_password = StringField(default='password', label='Password')

    smtp_enabled = BooleanField(default=False, label='Enabled')
    smtp_server = StringField(default='127.0.0.1', label='Server IP')
    smtp_port = IntegerField(default=25, label='Port')
    smtp_active_range = StringField(validators=[validate_time_range], default='00:00 - 23:59',
                                    description='<small><em>hh:mm - hh:mm</em></small>', label='Activity Time')
    smtp_sleep_interval = StringField(default=720, label='Sleep Interval')
    smtp_activation_probability = StringField(default=0.4, label='Activation Probability')
    smtp_login = StringField(default='test', label='Login')
    smtp_local_hostname = StringField(default='localhost', label='Hostname')
    smtp_password = StringField(default='password', label='Password')

    vnc_enabled = BooleanField(default=False, label='Enabled')
    vnc_server = StringField(default='127.0.0.1', label='Server IP')
    vnc_port = IntegerField(default=5900, label='Port')
    vnc_active_range = StringField(validators=[validate_time_range], default='00:00 - 23:59',
                                   description='<small><em>hh:mm - hh:mm</em></small>', label='Activity Time')
    vnc_sleep_interval = StringField(default=720, label='Sleep Interval')
    vnc_activation_probability = StringField(default=0.4, label='Activation Probability')
    vnc_login = StringField(default='test', label='Login')
    vnc_password = StringField(default='password', label='Password')

    telnet_enabled = BooleanField(default=False, label='Enabled')
    telnet_server = StringField(default='127.0.0.1', label='Server IP')
    telnet_port = IntegerField(default=23, label='Port')
    telnet_active_range = StringField(validators=[validate_time_range], default='00:00 - 23:59',
                                      description='<small><em>hh:mm - hh:mm</em></small>', label='Activity Time')
    telnet_sleep_interval = StringField(default=720, label='Sleep Interval')
    telnet_activation_probability = StringField(default=0.4, label='Activation Probability')
    telnet_login = StringField(default='test', label='Login')
    telnet_password = StringField(default='password', label='Password')

    ssh_enabled = BooleanField(default=False, label='Enabled')
    ssh_server = StringField(default='127.0.0.1', label='Server IP')
    ssh_port = IntegerField(default=22, label='Port')
    ssh_active_range = StringField(validators=[validate_time_range], default='00:00 - 23:59',
                                   description='<small><em>hh:mm - hh:mm</em></small>', label='Activity Time')
    ssh_sleep_interval = StringField(default=720, label='Sleep Interval')
    ssh_activation_probability = StringField(default=0.4, label='Activation Probability')
    ssh_login = StringField(default='test', label='Login')
    ssh_password = StringField(default='password', label='Password')

    ftp_enabled = BooleanField(default=False, label='Enabled')
    ftp_server = StringField(default='127.0.0.1', label='Server IP')
    ftp_port = IntegerField(default=21, label='Port')
    ftp_active_range = StringField(validators=[validate_time_range], default='00:00 - 23:59',
                                   description='<small><em>hh:mm - hh:mm</em></small>', label='Activity Time')
    ftp_sleep_interval = StringField(default=720, label='Sleep Interval')
    ftp_activation_probability = StringField(default=0.4, label='Activation Probability')
    ftp_login = StringField(default='test', label='Login')
    ftp_password = StringField(default='password', label='Password')
