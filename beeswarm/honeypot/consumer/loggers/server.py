...
class Server(LoggerBase):
    def __init__(self, config):
        ...
        self.server_url = config['beeswarm_server']['managment_url']
        ...
        self.push_socket.connect("tcp://127.0.0.1:5558")

    def log(self, session):
        data = json.dumps(session, default=json_default)
