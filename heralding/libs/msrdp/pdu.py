...
class ServerData:
    ...
    def generate(cls, cReqproto):
        ...
        pubkeyProps_2 = b'RSA1H\x00\x00\x00\x00\x02\x00\x00?\x00\x00\x00'
        pubExp = b'\x01\x00\x01\x00'
...
class MCSConnectResponsePDU():
    ...
    def __init__(self, cReqproto):
        self.cReqproto = cReqproto

    def generate(self):
        serverData = ServerData.generate(self.cReqproto)
